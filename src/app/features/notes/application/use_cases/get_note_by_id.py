from src.app.features.notes.application.dtos.note_dto import NoteResponse
...
class GetNoteByIdUseCase:
    """Retrieve a single note by ID, validating project ownership."""

    def __init__(self, note_repository: NoteRepository, project_repository: ProjectRepository):
        self._note_repository = note_repository
        self._project_repository = project_repository

    async def execute(self, note_id: str, owner_id: str) -> NoteResponse:
        ...
        return map_entity_to_response(note)
